        ...
        @if(!empty($tagName))
            <div class="row b-tag-title">
                <div class="col-xs-12 col-md-12 col-lg-12">
                    <h2>拥有<span class="b-highlight">标签标签</span>标签的文章</h2>
                </div>
            </div>
        @endif
        @if(request()->has('wd'))
            ...
            @foreach($article as $k => $v)
                <div class="row b-one-article">
                    <h3 class="col-xs-12 col-md-12 col-lg-12">
                        <a class="b-oa-title" href="" target="_blank">{{$v->title}}</a>
                    </h3>
                    <div class="col-xs-12 col-md-12 col-lg-12 b-date">
                        <ul class="row">
                            ...
                            <li class="col-xs-5 col-md-2 col-lg-2">
                                <i class="fa fa-list-alt"></i> <a href="" target="_blank">{{$v->category->name}}</a>
                            </li>
                            <li class="col-xs-7 col-md-5 col-lg-4 "><i class="fa fa-tags"></i>
                                @foreach($v->tag as $kk => $vv)
                                    <a class="b-tag-name" href="" target="_blank">{{$vv->name}}</a>
                                @endforeach
                            </li>
                        </ul>
                    </div>
                            ...
                            <div class="col-sm-6 col-md-6 col-lg-4 hidden-xs">
                                <figure class="b-oa-pic b-style1">
                                    <a href="" target="_blank">
                                        <img src="{{ asset('uploads/avatar/default.jpg') }}" alt="" title="">
                                    </a>
                                    <figcaption>
